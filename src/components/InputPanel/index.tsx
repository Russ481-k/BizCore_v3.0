...
function InputPanel({
  ...
  const [isOpenTemplateSaveModalData, setOpenConfirmModalData] =
  ...
  const handleTemplateSaveModalClose = () => {
    setOpenConfirmModalData(null);
  };
  ...
  return (
    <FormProvider {...methods}>
      <Flex flex={1} flexDirection="column" gap={3} width="100%">
            ...
            {!isAlarmTalk && (
              <InfoElement label="메시지 제목" width="100%">
                ...
                >
                  ...
                  <TipText
                    size="sm"
                    text="단문(SMS)은 메시지 제목이 전송되지 않으며, 발송 관리용으로만
                    사용됩니다. 단문, 장문, 멀티 메시지의 제목 입력 없이 발송된
        ...
        {isOpenTemplateSaveModalData && (
          <SaveTemplateConfirmModal
            data={isOpenTemplateSaveModalData}
            onClose={handleTemplateSaveModalClose}
          />
        )}
      </Flex>
    </FormProvider>
