                ...
                <Flex flexDirection="column" my={3}>
                  ...
                  <TipText
                    ...
                    text={`지정된 bytes수 이상으로 치환코드값을 등록하여 문자
                        를 할 수 있습니다. 단, 단문 (SMS)의 경우 지정된 bytes수 이상 사용에 따라 장문 (LMS)으로 될 수 있습니다.`}
                  />
                </Flex>
              </InfoElement>
            </InfoBox>
...
감사합니다."
              ...
              <Flex align="center">
                ...
                <Text>다음과 같이 엑셀 혹은 대상자에 치환코드 값 등록</Text>
              </Flex>
              <Flex align="center">
                <Center
                  backgroundColor="primary.500"
