...
interface EmergencyStaffAddressTabProps {
  addressData: Subject[];
...
function EmergencyStaffAddressTab({
  addressData,
  setOpen,
  onChange,
}: EmergencyStaffAddressTabProps) {
    ...
    <Flex gap={3} height="640px">
      ...
      >
        <Flex flexDirection="column" height="580px" overflowY="auto">
          ...
          >{`직원 비상 연락망 전체 (${addressTotalCount ?? 0})`}</Button>
          {!!addressGroups &&
...
export default EmergencyStaffAddressTab;
