      ...
      deleteTemplate(
        { templateId },
        {
          onError: (error) => {
            toast({
              render: () => (
                <ToastMessage title="문자 템플릿 삭제 오류" type="ERROR">
                  {error.message}
                  <br />
          ...
          onSuccess: () => {
            toast({
              render: () => (
                <ToastMessage title="문자 템플릿 삭제 완료" type="SUCCESS">
                  문자 템플릿을 정상적으로 삭제하였습니다.
                </ToastMessage>
              ),
            });
            handleModalClose();
            ...
            toast({
              render: () => (
                <ToastMessage title="문자 템플릿 등록 오류" type="ERROR">
                  {error.message}
                  <br />
                  문자 템플릿 등록 중 알 수 없는 오류가 발생하였습니다.
                  <br />
                  문자 템플릿 등록을 다시 수정하세요. 본 오류가 계속 발생하는
                  경우 시스템 관리자에게 문의하기 바랍니다.
                </ToastMessage>
              ),
            });
      ...
      changeTemplate(
        ...
        },
        {
          onError: (error) => {
            toast({
              render: () => (
                <ToastMessage title="문자 템플릿 수정 오류" type="ERROR">
                  {error.message}
                  <br />
                  문자 템플릿 수정 중 알 수 없는 오류가 발생하였습니다.
                  <br />
                  문자 템플릿을 다시 수정하세요. 본 오류가 계속 발생하는 경우
                  시스템 관리자에게 문의하기 바랍니다.
                </ToastMessage>
              ),
            });
          ...
          onSuccess: () => {
            toast({
              render: () => (
                <ToastMessage title="문자 템플릿 수정 완료" type="SUCCESS">
                  문자 템플릿을 정상적으로 수정하였습니다.
                </ToastMessage>
              ),
            });
            handleModalClose();
  ...
  return (
    <CustomModal isOpen onClose={onClose}>
      <ModalContent minW="1200px">
        <ModalHeader>
          문자 템플릿 {isChangeTemplate ? "수정" : "등록"}
        </ModalHeader>
        <ModalCloseButton />
        <ModalBody overflowY="auto">
          <FormProvider {...methods}>
            <Flex flexDirection="column" gap={3}>
              <CollapseSection headerTitle="문자 템플릿 기본 정보">
                <InfoBox>
                  {isChangeTemplate && (
                    <Flex>
              ...
              <CollapseSection headerTitle="문자 템플릿 내용 등록">
