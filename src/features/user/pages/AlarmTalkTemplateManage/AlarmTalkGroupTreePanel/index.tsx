...
import { useGetAlarmTalkTemplateGroups } from "features/template";
...
interface AlarmTalkGroupTreePanelProps {
  isRefetch: boolean;
  onChange: (groupTemplate: TemplateGroup | null) => void;
  onRefetch: (isRefetch: boolean) => void;
}

function AlarmTalkGroupTreePanel({
  isRefetch,
  onChange,
  onRefetch,
}: AlarmTalkGroupTreePanelProps) {
  ...
  return (
    <Flex flexDirection="column" justifyContent="space-between" py={0}>
      <Flex flexDirection="column" gap={3}>
        <CollapseSection headerTitle="알림톡 템플릿 그룹" width="300px">
...
export default AlarmTalkGroupTreePanel;
